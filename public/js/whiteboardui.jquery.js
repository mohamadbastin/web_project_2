(function() {
    ...
    window.WhiteboardUi = {
        ...
        addListeners: function() {
            ...
            WhiteboardUi.getElement('pink').mousedown(function() {
                Whiteboard.setStrokeStyle(WhiteboardUi.getElement('pink').attr("value"));
                WhiteboardUi.activatePencil();
                WhiteboardUi.shapeMenu();
                $(".toggle-button").parent().find("ul").slideToggle(function() {
                    // Animation complete.
            ...
            WhiteboardUi.getElement('new-page').mouseup(function() {
