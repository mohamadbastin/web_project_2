  ...
  window.Whiteboard = {
    ...
    execute: function (wbevent, firstexecute) {
      ...
      if (type === "beginpath") {
        ...
        this.context.save();
        this.context.beginPath();
      } else if (type === "beginText") {
        // FLAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAG
        this.context.save();
        ...
        Whiteboard.canvas.addEventListener(
          "click",
          function (e) {
            mouseX = e.pageX - Whiteboard.canvas.offsetLeft;
            mouseY = e.pageY - Whiteboard.canvas.offsetTop - 65;
            startingX = mouseX;
    ...
    upimg: function () {
      /////////////////// fix the width and height of the
    ...
    saveAs: function (type) {
      ...
      var options =
        "width=" +
        Whiteboard.canvas.width +
        "," +
        "height=" +
        Whiteboard.canvas.height;
    ...
    animatenext: function () {
      ...
      if (Whiteboard.animationind < Whiteboard.events.length - 1) {
        ...
        var dtime =
          Whiteboard.events[Whiteboard.animationind + 1].time -
          Whiteboard.events[Whiteboard.animationind].time;
